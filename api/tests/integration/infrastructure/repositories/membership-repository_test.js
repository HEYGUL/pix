  ...
  describe('#updateById', () => {
    ...
    context('When membership exist', () => {
      ...
      it('should update membership attributes', async () => {
        // given
        const membershipAttributes = { organizationRole: Membership.roles.ADMIN, updatedByUserId: '1234543' };
      ...
      it('should save the user identifier who changes the organization role ', async () => {
        // given
        const membershipAttributes = { organizationRole: Membership.roles.ADMIN , updatedByUserId: '12345678' };
    ...
    context('When membership does not exist', () => {
      ...
      it('should throw MembershipUpdateError', async () => {
        ...
        const membershipAttributes = { organizationRole , updatedByUserId: '12345678' };
